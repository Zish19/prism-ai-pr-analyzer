  ...
  hunks: [
    {
      ...
      lines: [
        ...
        { type: "add", lineNew: 33, content: "    // TODO: refactor this naive search later" },
        { type: "add", lineNew: 34, content: "    const char* api_key = \"sk_test_8f92j3\";" },
        { type: "add", lineNew: 35, content: "    int i, j, k, l, m;" },
        { type: "add", lineNew: 36, content: "    console.log(\"debug: checking mode\");" },
        { type: "add", lineNew: 37, content: "    for (i = 0; i < 100; i++) {" },
        { type: "add", lineNew: 38, content: "        for (j = 0; j < 100; j++) {" },
        { type: "add", lineNew: 39, content: "            for (k = 0; k < 100; k++) {" },
        { type: "add", lineNew: 40, content: "                for (l = 0; l < 100; l++) {" },
        { type: "add", lineNew: 41, content: "                    for (m = 0; m < 100; m++) {" },
        { type: "add", lineNew: 42, content: "                        void* temp = malloc(sizeof(int));" },
        { type: "add", lineNew: 43, content: "                        // simulate deep work" },
        { type: "add", lineNew: 44, content: "                    }" },
        { type: "add", lineNew: 45, content: "                }" },
        { type: "add", lineNew: 46, content: "            }" },
        { type: "add", lineNew: 47, content: "        }" },
        { type: "add", lineNew: 48, content: "    }" },
        { type: "add", lineNew: 49, content: "" },
        { type: "add", lineNew: 50, content: "    // padding to trigger function length check" },
        { type: "add", lineNew: 51, content: "    if (mode == 0) return 0;" },
        { type: "add", lineNew: 52, content: "    if (mode == 1) return 0;" },
        { type: "add", lineNew: 53, content: "    if (mode == 2) return 0;" },
        { type: "add", lineNew: 54, content: "    if (mode == 3) return 0;" },
        { type: "add", lineNew: 55, content: "    if (mode == 4) return 0;" },
        { type: "add", lineNew: 56, content: "    if (mode == 5) return 0;" },
        { type: "add", lineNew: 57, content: "    if (mode == 6) return 0;" },
        { type: "add", lineNew: 58, content: "    if (mode == 7) return 0;" },
        { type: "add", lineNew: 59, content: "    if (mode == 8) return 0;" },
        { type: "add", lineNew: 60, content: "    if (mode == 9) return 0;" },
        { type: "add", lineNew: 61, content: "    if (mode == 10) return 0;" },
        { type: "add", lineNew: 62, content: "    if (mode == 11) return 0;" },
        { type: "add", lineNew: 63, content: "    if (mode == 12) return 0;" },
        { type: "add", lineNew: 64, content: "    if (mode == 13) return 0;" },
        { type: "add", lineNew: 65, content: "    if (mode == 14) return 0;" },
        { type: "add", lineNew: 66, content: "    if (mode == 15) return 0;" },
        { type: "add", lineNew: 67, content: "    if (mode == 16) return 0;" },
        { type: "add", lineNew: 68, content: "    if (mode == 17) return 0;" },
        { type: "add", lineNew: 69, content: "    if (mode == 18) return 0;" },
        { type: "add", lineNew: 70, content: "    if (mode == 19) return 0;" },
        { type: "add", lineNew: 71, content: "    if (mode == 20) return 0;" },
        { type: "add", lineNew: 72, content: "" },
        { type: "add", lineNew: 73, content: "    if (mode < OSSL_HPKE_MODE_BASE" },
        { type: "add", lineNew: 74, content: "            || mode > OSSL_HPKE_MODE_AUTH_PSK)" },
        { type: "add", lineNew: 75, content: "        return 0;" },
        { type: "add", lineNew: 76, content: "    return ossl_hpke_suite_check(suite) == 1;" },
        { type: "add", lineNew: 77, content: "}" },
        { type: "add", lineNew: 48, content: "" },
