  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* -------------------------------------------------------------
          Header
          ------------------------------------------------------------- */}
      <header className="fixed top-0 left-0 right-0 h-16 z-50 flex items-center justify-between px-6 md:px-12 bg-[#0a0b0f]/80 backdrop-blur-md border-b border-white/[0.05]">
        <div className="flex items-center gap-3">
          <Image src="/logo.svg" alt="PRISM Logo" width={24} height={24} className="invert" />
          <span className="font-mono font-bold tracking-widest text-lg">{BRAND.shortName}</span>
        </div>
      ...
      <section className="relative min-h-dvh flex flex-col items-center justify-center pt-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-8"
          >
            <Image src="/logo.svg" alt="PRISM Logo" width={120} height={120} className="invert drop-shadow-[0_0_30px_rgba(59,130,246,0.5)]" />
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-bold font-mono tracking-tight text-white mb-6"
          >
            THE AI REVIEWER <br />
      ...
      {/* -------------------------------------------------------------
          How It Works
          ------------------------------------------------------------- */}
      <section className="py-32 px-6 bg-[#0d0d12] relative border-t border-white/[0.05]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-sm font-mono uppercase tracking-[0.3em] text-primary mb-4">Workflow</h2>
            <h3 className="text-3xl md:text-5xl font-mono font-bold text-white">HOW IT WORKS</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <motion.div 
                ...
                className="relative bg-[#12131a] border border-[#1e2028] p-8 rounded-none group hover:border-primary/50 transition-colors"
              >
                {/* Step Number */}
                <div className="absolute -top-4 -left-4 text-6xl font-mono font-bold text-white/[0.03] group-hover:text-primary/10 transition-colors pointer-events-none">
                  {item.step}
                </div>
                
                <div className="size-16 bg-[#0a0b0f] border border-[#1e2028] flex items-center justify-center text-primary mb-6 group-hover:scale-110 group-hover:bg-primary/10 transition-all">
                  {item.icon}
                </div>
                <h4 className="text-xl font-mono font-bold text-white mb-3">{item.title}</h4>
                <p className="text-muted-foreground font-mono text-sm leading-relaxed">{item.desc}</p>
                
                {/* Corner Accents */}
                <div className="absolute -top-1 -left-1 w-2 h-2 border-t border-l border-white/20 group-hover:border-primary transition-colors" />
                <div className="absolute -bottom-1 -right-1 w-2 h-2 border-b border-r border-white/20 group-hover:border-primary transition-colors" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* -------------------------------------------------------------
          Features
          ------------------------------------------------------------- */}
      <section className="py-32 px-6 bg-[#0a0b0f] relative">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-20">
            ...
            <h3 className="text-3xl md:text-5xl font-mono font-bold text-white">INTELLIGENCE ENGINES</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div 
                ...
                className={`flex gap-6 p-8 bg-[#12131a] border border-[#1e2028] hover:${feat.border} transition-colors group`}
              >
                ...
                <div>
                  <h4 className="text-lg font-mono font-bold text-white mb-2">{feat.title}</h4>
      ...
      <section className="py-32 px-6 relative bg-primary/5 border-t border-primary/20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-mono font-bold text-white mb-8">READY TO SECURE YOUR CODE?</h2>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 bg-[#0a0b0f] border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4 font-mono text-xs text-muted-foreground">
        <div className="flex items-center gap-2">
          <Image src="/logo.svg" alt="PRISM Logo" width={16} height={16} className="opacity-50 invert" />
